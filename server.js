...
app.get("/home", function (req, res) {
  res.sendFile(path.join(__dirname + "/views/Zech_Jordan.html"));
})

app.get("/choice", function (req, res) {
  res.sendFile(path.join(__dirname + "/views/mychoice.html"));
})
...
app.post("/new-entry", function (request, response) {
  ...
  response.redirect("/contact"); // where to go next? Let's go to the home page :)
});
